...
#endif
{
  ...
  // Expanded ESP32 Full builds run MQTT and ESP-NOW on the same 2.4 GHz
  // station interface. MQTT owns the WiFi connection; ESP-NOW must therefore
  // use that AP's channel (ESPNowBridge rejects a mismatch at start).
