...
apply_cli_radio_preset() {
  ...
  case "${selection,,}" in
    usa-cascade-fixed|usa-cascadia-fixed)
      set_usa_cascadia_radio_fallback
      echo "Using fixed USA Cascade ${RADIO_FREQ_OVERRIDE}MHz / SF${RADIO_SF_OVERRIDE} / BW${RADIO_BW_OVERRIDE} / CR${RADIO_CR_OVERRIDE}."
      return 0
      ;;
