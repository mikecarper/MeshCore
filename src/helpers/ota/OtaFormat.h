...
enum OtaMsgType : uint8_t {
  ...
  OTA_REQ_PROOF    = 0x08,   // request/re-request proof (legacy-source or lost proactive-proof fallback)
  OTA_PROOF        = 0x09,   // the merkle proof for one block (normally follows its paced DATA)
