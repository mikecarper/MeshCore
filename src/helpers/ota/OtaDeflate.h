...
public:
  ...
  static bool send_trampoline(void* ctx, const uint8_t* msg, uint16_t len, bool flood);
...
private:
  ...
  bool send(const uint8_t* msg, uint16_t len, bool flood);
