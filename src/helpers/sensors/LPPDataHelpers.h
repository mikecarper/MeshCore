...
#define LPP_TEMPERATURE 103         // 2 bytes, 0.1degC signed
...
#define LPP_GYROMETER 134           // 2 bytes per axis, 0.01 deg/s
#define LPP_COLOUR 135              // 1 byte per RGB Color
#define LPP_GPS 136                 // 3 byte lon/lat 0.0001 deg, 3 bytes alt 0.01 meter
#define LPP_SWITCH 142              // 1 byte, 0/1
#define LPP_POLYLINE 240            // 1 byte size, 1 byte delta factor, 3 byte lon/lat 0.0001deg * factor, n (size-8) bytes deltas
