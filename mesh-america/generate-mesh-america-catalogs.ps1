...
$RolePatterns = @(
    ...
    @{ Suffix = 'companion_radio_ble_femon'; Role = 'companionBle'; Title = 'Companion BLE'; SubTitle = 'FEM runtime-configurable' },
    @{ Suffix = 'companion_radio_ble_ps_femoff'; Role = 'companionBle'; Title = 'Companion BLE'; SubTitle = 'Power saving, FEM off' },
    @{ Suffix = 'companion_radio_ble_ps_femon'; Role = 'companionBle'; Title = 'Companion BLE'; SubTitle = 'Legacy alias; settings runtime-configurable' },
    ...
    @{ Suffix = 'companion_radio_usb_femoff'; Role = 'companionUsb'; Title = 'Companion USB'; SubTitle = 'FEM off' },
    @{ Suffix = 'companion_radio_usb_femon'; Role = 'companionUsb'; Title = 'Companion USB'; SubTitle = 'FEM runtime-configurable' },
    ...
    @{ Suffix = 'companion_radio_wifi_mqtt_femoff'; Role = 'companionWifi'; Title = 'Companion WiFi MQTT'; SubTitle = 'FEM off' },
    @{ Suffix = 'companion_radio_wifi_mqtt_femon'; Role = 'companionWifi'; Title = 'Companion WiFi MQTT'; SubTitle = 'FEM runtime-configurable' },
    @{ Suffix = 'companion_radio_wifi_femoff'; Role = 'companionWifi'; Title = 'Companion WiFi'; SubTitle = 'FEM off' },
    @{ Suffix = 'companion_radio_wifi_femon'; Role = 'companionWifi'; Title = 'Companion WiFi'; SubTitle = 'FEM runtime-configurable' },
...
$DeviceNameOverrides = @{
    ...
    'ikoka_handheld_nrf_e22_30dbm_096' = 'Ikoka Handheld nRF E22 30 dBm'
    'ikoka_handheld_nrf_e22_30dbm_096_rotated' = 'Ikoka Handheld nRF E22 30 dBm'
