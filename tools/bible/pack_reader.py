...
from zopfli_compress import ZOPFLI_VERSION, raw_deflate_compress  # noqa: E402
...
def pack(document, block_size=BLOCK_SIZE):
    ...
    for first_verse, block in zip(starts, blocks):
        compressed = raw_deflate_compress(block)
...
def render(document):
    ...
    lines = ["// Generated by tools/bible/pack_reader.py; do not edit.",
             f"// Compressed with Google Zopfli {ZOPFLI_VERSION} (15 iterations).",
